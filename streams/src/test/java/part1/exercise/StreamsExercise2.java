...
public class StreamsExercise2 {
    ...
    public void greatestExperiencePerEmployer() {
        ...
        Map<String, Person> result = employees.stream()
                .flatMap(employee -> employee.getJobHistory().stream()
                        ...
                        .entrySet().stream()
                        .map(pair -> new PersonEmployerWithDuration(employee.getPerson(), pair.getKey(), pair.getValue())))
                .collect(Collectors.groupingBy(PersonEmployerWithDuration::getEmployer,
                        Collectors.collectingAndThen(Collectors.maxBy(Comparator.comparing(PersonEmployerWithDuration::getDuration)),
    ...
    private static class PersonEmployerWithDuration {
        private Person person;
        private String employer;
        private int duration;

        public PersonEmployerWithDuration(Person person, String employer, int duration) {
            this.person = person;
            this.employer = employer;
